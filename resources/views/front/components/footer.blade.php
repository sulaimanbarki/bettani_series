                        ...
                        <div class="pb-6">
                            ...
                            <div class="mb-4">
                                <a href="mailto:{{ $website->email }}"
                                    class="font-size-2 d-block link-black-100 mb-1">{{ $website->email }}</a>
                                <a href="tel:{{ $website->phone }}"
                                    class="font-size-2 d-block link-black-100">{{ $website->phone }}</a>
                            </div>
