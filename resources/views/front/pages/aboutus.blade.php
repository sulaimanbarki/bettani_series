...
@section('meta_description', $metaData['aboutus']['meta_description'] ?? $defaultMeta['meta_description'])
@section('meta_keywords', $metaData['aboutus']['meta_keywords'] ?? $defaultMeta['meta_keywords'])
                ...
                <div class="col-lg-9 mx-auto">
                    <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-4">
                        <div class="mb-4 mb-lg-7 ml-xl-4">
                            <h6 class="font-weight medium font-size-10 mb-4 mb-lg-7">Welcome to Bettani Series</h6>
                            <p class="font-weight-medium font-italic">“Bettani Series is the key source for all those candidates who want preparation for various competitive tests.”</p>
                        </div>
                        <div class="mb-4 pb-xl-1 ml-xl-4">
                            <h6 class="font-weight-medium font-size-4 mb-4">What we really do?</h6>
                            <p class="font-size-2">Bettani Series is basically the technological root with numbers of books both in hard and soft form available in the market as well as online www.bettaniseries.com which is the dire need of the day to avoid tests related confusion at all. The team of Bettani Series highly appreciates reformative comments of the well wishers and candidates after studying books and extra mandatory learning materials available on this website and market .</p>
                        </div>
                        <div class="ml-xl-4">
                            <div class="row">
                                <!--<div class="col-md-6">-->
                                ...
                                <!--</div>-->
                                <div class="col-md-12">
                                    <h6 class="font-weight-medium font-size-4">Thank you</h6>
