...
@section('meta_description', $metaData['privacy-page']['meta_description'] ?? $defaultMeta['meta_description'])
@section('meta_keywords', $metaData['privacy-page']['meta_keywords'] ?? $defaultMeta['meta_keywords'])
...
<main id="content">
    <div class="mb-5 space-bottom-lg-3">
        <div class="py-3 py-lg-7">
            <h6 class="font-weight-medium font-size-7 text-center my-1">Privacy Policy</h6>
        </div>
        <!-- <img class="img-fluid" src="../../assets/img/1920x650/img1.jpg" alt="Image-Description"> -->
        <div class="container">
            <h1>Privacy Policy for Bettani Series</h1>

            <p>At Bettani Series, accessible from https://bettaniseries.com/, one of our main priorities is the privacy
                of our visitors. This Privacy Policy document contains types of information that is collected and
                recorded by Bettani Series and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in Bettani Series. This policy is not
            ...
            <p>Bettani Series follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Bettani Series uses "cookies". These cookies are used to store information
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Bettani
                Series.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Bettani Series, which are sent directly
            ...
            <p>Note that Bettani Series has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>Bettani Series's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>Bettani Series does not knowingly collect any Personal Identifiable Information from children under the
