...
<main id="content">
    <div class="mb-5 space-bottom-lg-3">
        <div class="py-3 py-lg-7">
            <h6 class="font-weight-medium font-size-7 text-center my-1">Terms and Conditions</h6>
        </div>
        <!-- <img class="img-fluid" src="../../assets/img/1920x650/img1.jpg" alt="Image-Description"> -->
        <div class="container">
            <h2><strong>Terms and Conditions</strong></h2>

            <p>Welcome to Bettani Series!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Bettani Series's Website,
                located at https://bettaniseries.com/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Bettani
                Series if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing Bettani Series, you agreed to use cookies in agreement with
                the Bettani Series's Terms and Conditions. </p>
            ...
            <p>Unless otherwise stated, Bettani Series and/or its licensors own the intellectual property rights for all
                material on Bettani Series. All intellectual property rights are reserved. You may access this from
                Bettani Series for your own personal use subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Bettani Series</li>
                <li>Sell, rent or sub-license material from Bettani Series</li>
                <li>Reproduce, duplicate or copy material from Bettani Series</li>
                <li>Redistribute content from Bettani Series</li>
            </ul>

            <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the
                <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms and Conditions Generator</a>.</p>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Bettani Series does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of Bettani Series,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Bettani Series shall not be liable for the
            ...
            <p>Bettani Series reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant Bettani Series a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Bettani Series; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Bettani Series. Please include your name, your
            ...
            <p>No use of Bettani Series's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
