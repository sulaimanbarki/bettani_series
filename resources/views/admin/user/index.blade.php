                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'cnic'">{{ trans('admin.user.columns.cnic') }}</th>
                                    ...
                                    <!-- <th is='sortable' :column="'province'">{{ trans('admin.user.columns.province') }}</th> -->
                                    <!-- <th is='sortable' :column="'district'">{{ trans('admin.user.columns.district') }}</th> -->
                                    <!-- <th is='sortable' :column="'professional'">{{ trans('admin.user.columns.professional') }}</th> -->
                                    ...
                                    <!-- <th is='sortable' :column="'active'">{{ trans('admin.user.columns.active') }}</th> -->
