...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('meta_keywords'), 'has-success': fields.meta_keywords && fields.meta_keywords.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <textarea v-model="form.meta_keywords" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('meta_keywords'), 'form-control-success': fields.meta_keywords && fields.meta_keywords.valid}" id="meta_keywords" name="meta_keywords" placeholder="meta keywords for SEO (comma separated)"></textarea>
