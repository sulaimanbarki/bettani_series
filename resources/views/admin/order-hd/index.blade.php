                                ...
                                <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                    ...
                                    <td>
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-auto">
                                                <a target="_blank" class="btn btn-sm btn-info" :href="'impersonate/'+ item.user_id" title="{{ trans('brackets/admin-ui::admin.btn.show') }}" role="button"><i class="fa fa-user"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
