...
class SettingsController extends Controller
{
    ...
    public function index(IndexSetting $request)
    {
        ...
        $data = AdminListing::create(Setting::class)->processRequestAndGet(
            ...
            ['id', 'name', 'logo', 'footerlogo', 'email', 'phone', 'facebook', 'youtube', 'instagram', 'twitter', 'pinterest'],

            // set columns to searchIn
            ['id', 'name', 'logo', 'footerlogo', 'address', 'email', 'phone', 'facebook', 'youtube', 'instagram', 'twitter', 'pinterest', 'footer', 'copyright', 'map']
        );
